...
function dp1() {
 if (nodmg === true) {
  ...
  if (skiller === "でんこうそうげき1") {
   alert(Pnameon + "の" + PN1 + "はでんきを使い果たした！");
   PM[ID].color2 = "#FFFFFF";
...
function dp11() {
 if (sturdy2 === true) {
  ...
  if (breakPB2 === true) {
   breakPB2 = false;
   alert(PN2 + "側のリフレクターがなくなった！");
  };
  if (breakSB2 === true) {
   breakSB2 = false;
   alert(PN2 + "側のひかりのかべがなくなった！");
  };
  if (breakOB2 === true) {
   breakOB2 = false;
   alert(PN2 + "側のオーロラベールがなくなった！");
  };
  if (PBing1 === true) {
   PBing1 = false;
...
function dp2() {
 if (nodmg === true) {
  alert(Pnameon + "の" + PN1 + "には" + display[dmg].dp);
  Wattack = false;
  AH = false;
  dmg = 2;
  Fdp21.style.visibility = "hidden";
...
function dp22() {
 if (sturdy1 === true) {
  ...
  if (smog === true) {
   smog = false;
   alert(Pnameon + "の" + PN1 + "の能力変化がもとに戻った！");
  };
  if (breakPB1 === true) {
   breakPB1 = false;
