  ...
  if (wince2 === true) {
   ...
   if ((nosong2 === true && Bskiller.song === true) || (gravities === true && Bskiller.skyjump === true)) {
    ...
    if (field === "phycho" && firster2 === true && PM[ID].bodytype1 !== "ひこう" && PM[ID].bodytype2 !== "ひこう" && F1 !== "ふゆう") {
     ...
     if ((chaos <= rank[KR1].KR * hitrate || F1 === "ノーガード" || F2 === "ノーガード" || (weather === "rainy" && (Bskiller.name === "かみなり" || Bskiller.name === "ぼうふう")) || (weather === "hail" && Bskiller.name === "ふぶき")) && (secondattack1 !== true || skiller.name === "ソーラービーム")) {
      if ((shield1 === true || MAXshield1 === true) && Bskiller.shieldbreak !== true && (Bskiller.direct !== true || F2 !== "ふかしのこぶし")) {
       ...
       if ((((F1 === "ふゆう" && gravities !== true) || F1 === "どしょく") && skilltype === "じめん") || (F1 === "ちょすい" && skilltype === "みず") || (F1 === "ちくでん" && skilltype === "でんき") || (F1 === "ぼうおん" && Bskiller.song === true) && F2 !== "かたやぶり") {
        flying1 = true;
       };
