function PKCO2() {
 ...
 if (BOSS.abnormal === "sleepy" || (BOSS.abnormal === "paralysis" && chaos <= 30)) {
  ...
  if (wince2 === true && BOSS.semiMAX !== true) {
   ...
   if ((nosong2 === true && Bskiller.song === true) || (gravities === true && Bskiller.skyjump === true)) {
    ...
    if (SNdp === "シャドースチール2" && (AR1 > 6 || BR1 > 6 || CR1 > 6 || DR1 > 6 || SR1 > 6)) {
     if (AR1 > 6) {
      AR2 = AR1;
      AR1 = 6; 
     };
    ...
    if (field === "phycho" && firster2 === true && PM[ID].bodytype1 !== "ひこう" && PM[ID].bodytype2 !== "ひこう" && F1 !== "ふゆう") {
     ...
     if ((chaos <= rank[KR1].KR * hitrate || F1 === "ノーガード" || F2 === "ノーガード"  || BOSS.semiMAX === true || (weather === "rainy" && (Bskiller.name === "かみなり" || Bskiller.name === "ぼうふう")) || (weather === "hail" && Bskiller.name === "ふぶき")) && (secondattack1 !== true || skiller.name === "ソーラービーム")) {
      if ((shield1 === true || MAXshield1 === true) && Bskiller.shieldbreak !== true && (Bskiller.direct !== true || F2 !== "ふかしのこぶし")) {
       ...
       if (F1 === "くだけるよろい") {
        if (Bskiller.type === "physics" || Bskiller.type === "bodypress") {
         breakarmor = true;
        };
       };
       if (F2 === "むしのしらせ") {
