...
function start() {
 ...
 button.onclick = function() {
  ...
  localStorage.setItem("task2",Math.floor(150000 / Math.sqrt(BOSS[EN].MR) * DC[DCN].score * Math.sqrt(DC[DCN].score * 5) / 1000) * 1000 + 10000);
 ...
 window.addEventListener("keydown",function(e) {
  if (e.code === "KeyL" && EN !== 0) {
   ...
   task2.innerHTML = Math.floor(150000 / Math.sqrt(BOSS[EN].MR) * DC[DCN].score * Math.sqrt(DC[DCN].score * 5) / 1000) * 1000 + 10000;
