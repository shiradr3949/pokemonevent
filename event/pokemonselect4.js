...
const allup1 = localStorage.getItem("allup");
const allup2 = localStorage.getItem("allup2");
const allup3 = localStorage.getItem("allup3");
const allup4 = localStorage.getItem("allup4");
const allup5 = localStorage.getItem("allup5");
const allup6 = localStorage.getItem("allup6");
...
function start() {
 ...
 BOSS[eventnumber].MHP = Math.floor(BOSS[eventnumber].MHP * HPrate);
 BOSS[eventnumber].HP = Math.floor(BOSS[eventnumber].HP * HPrate);
 BOSS[eventnumber].A = Math.floor(BOSS[eventnumber].A * Rrate);
 BOSS[eventnumber].B = Math.floor(BOSS[eventnumber].B * Rrate);
 BOSS[eventnumber].C = Math.floor(BOSS[eventnumber].C * Rrate);
 BOSS[eventnumber].D = Math.floor(BOSS[eventnumber].D * Rrate);
 BOSS[eventnumber].S = Math.floor(BOSS[eventnumber].S * Rrate);
 if (allup1 === "true" || allup2 === "true" || allup3 === "true" || allup4 === "true" || allup5 === "true" || allup6 === "true") {
   BOSS[eventnumber].allup = true;
  if (allup1 === "true") {
   BOSS[eventnumber].upN = 1;
  };
  if (allup2 === "true") {
   BOSS[eventnumber].upN = 2;
  };
  if (allup3 === "true") {
   BOSS[eventnumber].upN = 3;
  };
  if (allup4 === "true") {
   BOSS[eventnumber].upN = 4;
  };
  if (allup5 === "true") {
   BOSS[eventnumber].upN = 5;
  };
  if (allup6 === "true") {
   BOSS[eventnumber].upN = 6;
  };
 };
 ...
 if (chaos <= 10) {
  ...
  data[20].MHP = Math.floor(data[20].MHP * 1.5 / 10) * 10;
  data[20].HP = Math.floor(data[20].HP * 1.5 / 10) * 10;
  data[20].A = Math.floor(data[20].A * 1.5 / 10) * 10;
  data[20].B = Math.floor(data[20].B * 1.5 / 10) * 10;
  data[20].C = Math.floor(data[20].C * 1.5 / 10) * 10;
  data[20].D = Math.floor(data[20].D * 1.5 / 10) * 10;
  data[20].S = Math.floor(data[20].S * 1.5 / 10) * 10;
 ...
 PK1.onclick = function() {
  if (PM2 === false) {
   PK1.src = "../pokemonquestimg/monsterball.png";
   PM1 = false;
  };
 };
 PK2.onclick = function() {
  if (PM3 === false) {
   PK2.src = "../pokemonquestimg/monsterball.png";
   PM2 = false;
  };
 };
 PK3.onclick = function() {
  if (PM4 === false) {
   PK3.src = "../pokemonquestimg/monsterball.png";
   PM3 = false;
  };
 };
 PK4.onclick = function() {
  if (PM5 === false) {
   PK4.src = "../pokemonquestimg/monsterball.png";
   PM4 = false;
  };
 };
 PK5.onclick = function() {
  if (PM6 === false) {
   PK5.src = "../pokemonquestimg/monsterball.png";
   PM5 = false;
  };
 };
 PK6.onclick = function() {
  PK6.src = "../pokemonquestimg/monsterball.png";
  PM6 = false;
  setbutton.style.visibility = "hidden";
 };
...
function changerotom() {
 ...
 display.style.backgroundImage = `url(${rotom[number].img})`;
 ...
 speed.innerHTML = rotom[number].S;
 skilldp1.innerHTML = skill[data[ID].skill1].name;
 skilldp2.innerHTML = skill[data[ID].skill2].name;
 skilldp3.innerHTML = skill[data[ID].skill3].name;
 skilldp4.innerHTML = skill[data[ID].skill4].name;
